...
| -------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| orders.csv         | This table contains order level facts related to the dataset, such as Order ID and Order Date.                                                                                                                  |
| order_payments.csv | This table contains payment details related to the datasets, such as Payment Type and Payment Value.                                                                                                            |
| customers.csv      | This table contains information about the customer and its location.                                                                                                                                            |
